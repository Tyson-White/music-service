export default function ArrowIcon({ className = "" }) {
  return (
    <svg className={className} viewBox="0 -4.5 20 20" version="1.1" xmlns="http://www.w3.org/2000/svg" fill="#000000">
      <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
      <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
      <g id="SVGRepo_iconCarrier">
        {" "}
        <title>arrow_up [#340]</title> <desc>Created with Sketch.</desc> <defs> </defs>{" "}
