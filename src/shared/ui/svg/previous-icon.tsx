export default function PreviousIcon({ className = "" }) {
  return (
    <svg className={className} fill="#fff" viewBox="0 0 32 32" version="1.1" xmlns="http://www.w3.org/2000/svg">
      ...
      <g id="SVGRepo_iconCarrier">
        ...
        <g id="Icon">
          ...
          <path d="M3.977,4.987l-0.003,22c0,0.552 0.448,1.001 1,1.001c0.552,-0 1,-0.448 1,-1l0.003,-22c0.001,-0.552 -0.447,-1 -0.999,-1c-0.552,-0 -1,0.448 -1.001,0.999Z"></path>{" "}
        </g>{" "}
      </g>
    </svg>
  );
